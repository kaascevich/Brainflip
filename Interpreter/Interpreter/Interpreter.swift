...
public final class Interpreter {
    ...
    public enum EndOfInput: Int, CaseIterable, AppEnum {
        public static let typeDisplayRepresentation: TypeDisplayRepresentation = "End-of-Input Action"
        public static let caseDisplayRepresentations: [EndOfInput: DisplayRepresentation] = [
...
extension Interpreter {
    public enum CellSize: Int, CaseIterable, Hashable, AppEnum {
        public static let typeDisplayRepresentation: TypeDisplayRepresentation = "Cell Size"
        public static let caseDisplayRepresentations: [CellSize: DisplayRepresentation] = [
            .oneBit:       "1-Bit",
            .twoBit:       "2-Bit",
            .fourBit:      "4-Bit",
            .eightBit:     "8-Bit",
